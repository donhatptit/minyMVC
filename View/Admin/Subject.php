<?php include "View/Admin/Header.php"; ?>
						...
						<div class="row">
							...
							<div class="col-md-6 text-right">
								<div class="row">
									...
									<div class="col-md-4">
										<a href="index.php?action=add" class="btn btn-primary">Thêm</a>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="card-body">
						...
						<table class="table table-hover table-bordered">
							...
							<tbody class="danhsach">
								<?php
								while($rows = mysqli_fetch_array($subcontrol)){?>
									<tr>
					...
					<div class="card-footer" style="padding:7px !important">
						<ul class="pagination">
							...
							<?php  for($i = 1; $i<=$num_page; $i++): ?>
								<li class="page-item"><a class="page-link" href="admin.php?action=SubjectController&p=<?php echo $i; ?>"><?php echo $i; ?></a></li>
							<?php endfor; ?>
						</ul>
					</div>
				</div>
	...
	<script type="text/javascript" src="Public/Admin/js/sub.js"></script>
