				...
				<div class="card card-header badge-default text-black" style="padding:7px !important;">
					<div class="row">
						...
						<div class="col-md-6 text-right">
							<a href="admin.php?action=AddEditUser" class="btn btn-primary">Thêm</a>
						</div>
					</div>
				</div>
				...
				<div class="card-body">
					...
					<table class="table table-hover table-bordered">
						...
						<tbody class="danhsach">
							...
							while($rows = mysqli_fetch_array($usercontrol))	{?>
			...
			<div class="card-footer" style="padding:7px !important">
				<ul class="pagination">
					...
					<?php  for($i = 1; $i<=$num_page; $i++): ?>
						<li class="page-item"><a class="page-link" href="admin.php?action=UserController&p=<?php echo $i; ?>"><?php echo $i; ?></a></li>
					<?php endfor; ?>
				</ul>
			</div>
		</div>
